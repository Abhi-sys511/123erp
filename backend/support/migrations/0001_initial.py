    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assigned_care_exec', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assigned_tickets', to=settings.AUTH_USER_MODEL)),
